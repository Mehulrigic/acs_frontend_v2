...
const FilePage = () => {
  ...
  useEffect(() => {
    ...
    const can_delete_folder = JSON.parse(localStorage.getItem("can_delete_folder"));
        ...
        <div className="dashboard-main-content insurers-dashboard" style={{ backgroundColor: rightPanelThemeColor }}>
          <div className="top-header">
            ...
            <div className="mt-3 d-md-flex justify-content-between align-items-center">
              <h1 className="m-md-0 mb-3">Liste des dossiers ({totalRecords})</h1>
              <AddfolderPanel
                userRole={userRole}
                userName={userName}
                userId={userId}
                          ...
                          >
                            ...
                            {sort.value === "desc" &&
                              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                               ...
                               {selectedColumns.includes("client") && userRole !="Assureur" &&
                      <th>
                        <div className="d-flex align-items-center">
                          <span>Assureur</span>
                          <Link
                            className={`sorting-icon ms-2`}
                            onClick={() => handleClickRotate("client")}
                          >
                            {sort.value === "asc" &&
                              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M9 3L5 6.99H8V14H10V6.99H13L9 3ZM9 3L5 6.99H8V14H10V6.99H13L9 3Z" fill="black" />
                ...
                <tbody>
                  {(folderListData?.length > 0 && selectedColumns?.length > 0) ? (
                    ...
                    <tr style={{ textAlign: "center" }}>
                      <td colSpan={selectedColumns.length}>{t("NorecordsfoundLabel")}</td>
                    </tr>
                  )}
                </tbody>
              </Table>
